                ...
                if (a.indexOf("action=") >= 0 && url.ret.indexOf("K=") >= 0) {
                    ...
                    $.ajax({
                        ...
                        error: function (request, errorMsg) {
                            alert(String.format(gettext('Operating failed for {0} : {1}'), options.title, errorMsg));
                            $.unblockUI();
                        }
                    });
                }
...
function procMiniData(miniDataUrl) {
    ...
    if (typeof miniDataUrl == "string")
        $.ajax({
            type: "GET", url: miniDataUrl, dataType: "json",
...
function batchOp(action, itemCanSelect, opName) {
    ...
    else if (!opName) opName = gettext('Operation');
